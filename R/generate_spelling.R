...
generate_spelling <- function(save_pkg_data = TRUE) {
  ...
  proper_nouns <- c(
    "Anobel", "Aylin", "Burnand", "Charlson", "Christophe", "Deyo",
    "Deyo", "Druker", "Eddelbeuttel", "Eigen", "Elixhauser", "Elixhuaser",
    "Feinstein", "Feudtner", "Fong", "Galvez", "Ghali", "Guennebaud",
    "Hadley", "Hude", "Jarvi", "Kalibera", "Luthi", "Mansour", "Masino", "Odisho",
    "Petersburg", "ProPublica", "Quan", "Rehman", "RStudio", "Sharabiani", "Simpao",
    "Sundararajan", "Travis", "Ushey", "Vijaya", "Vitaly", "Walraven",
    "Waltham", "Wasey", "Wercker", "Wickham", "wmurphyrd", "Zhong"
  )
  proper_nouns <- c(proper_nouns, paste(proper_nouns, "'s", sep = ""))
  acronyms <- c(
    "AHRQ", "BISHCA", "BLAS", "CC", "CCs", "CCS", "CDC", "CIM", "CMS",
    "CRAN", "CSV", "DRG", "HCC", "HCCs", "HCUP", "HTN", "icd", "ICD",
    "JAMA", "LLVM", "NEDS", "NHDS", "nhds", "NSO", "PCCC", "PCS", "POA",
  ...
  other <- c(
    ...
    "performant", "precomputed", "prepend", "prepends", "pseudocode", "Rcpp", "RcppEigen", "requestor", "tidyverse",
    "TODO", "Transuranium", "unclassifiable", "vectorization", "VermontDepartmentofHealth",
    "VermontHospitalDischarge", "VignetteEngine", "VignetteIndexEntry",
    "wordagain", "www"
  )
