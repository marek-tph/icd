...
#'   valid input, skipping this check saves significant time.
#'   \code{icd::factor_is_valid} can be used independently.
#' @examples
#' \dontrun{
#' f <- factor(c(1, 2, 3))
...
refactor <- function(x,
  ...
  # test for duplicate levels in C++
  # if (anyDuplicated(levels)) {
  #   stop("New levels cannot have any duplicates")
  # }
  if (na.rm) {
